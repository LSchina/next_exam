...
) ENGINE = InnoDB AUTO_INCREMENT = 123457 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '管理员信息表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES (123456, '超级管理员', '男', '13652227857', '1253578873@qq.com', '123456', '551444444444447887', '0');
...
) ENGINE = InnoDB AUTO_INCREMENT = 20190019 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '考试管理表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of exam_manage
-- ----------------------------
INSERT INTO `exam_manage` VALUES (20190001, '期末考试1', '计算机网络', 1001, '2024-03-21', 90, '2018', '1', '计算机科学与技术', '软件工程学院', 86, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20190002, '期末考试2', '数据库理论', 1002, '2024-03-07', 90, '2018', '2', '网络工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20190003, '期末考试3', '数据结构', 1003, '2024-02-27', 90, '2017', '1', '软件工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20190005, '期末考试4', '计算机导论', 1004, '2024-03-14', 90, '2018', '1', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20190006, '期末考试5', '软件工程', 1005, '2024-03-21', 120, '2018', '1', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20190007, '期末考试6', '操作系统', 1006, '2024-03-13', 120, '2018', '2', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20190008, '期末考试7', 'C语言', 1007, '2024-03-13', 120, '2018', '1', '信息工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20190009, '期末考试8', '高等数学', 1008, '2024-03-07', 90, '2018', '1', '信息工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20190013, '测试', '测试', 1009, '2024-04-24', 120, '2017', NULL, '测试', '测试', 100, '期末考试', '请不要带与考试无关的书籍。');
INSERT INTO `exam_manage` VALUES (20190014, 'Java程序设计', 'Java程序设计', 1010, '2024-03-01', 60, '2022', NULL, '软件工程', '计算机学院', 100, '期末考试', '请规范作答');
INSERT INTO `exam_manage` VALUES (20190015, '考试', 'C#', 1011, '2024-03-13', 5, '大三', NULL, '软件工程', '计算机学院', 30, '期末考', '请规范作答2');
INSERT INTO `exam_manage` VALUES (20190016, '高等数学考试', '高等数学', 1012, '2024-03-20', 90, '2019', NULL, '数学工程', '数学院', NULL, '期末考试', NULL);
INSERT INTO `exam_manage` VALUES (20190017, '程序测试', '计算机网络', 1013, '2024-03-21', 90, '2018', NULL, '软件工程', '计算机学院', 0, '期末', NULL);
INSERT INTO `exam_manage` VALUES (20190018, '333', '333', 1014, '2024-03-22', 90, '3333', NULL, '333', '333', NULL, '333', '333');
...
) ENGINE = InnoDB AUTO_INCREMENT = 41 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '留言表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of message
-- ----------------------------
INSERT INTO `message` VALUES (37, '张三', '计算机网络考试好难', '2024-04-04');
INSERT INTO `message` VALUES (38, '李四', '练习了很多遍还是很难', '2024-04-04');
INSERT INTO `message` VALUES (39, '太难啊了', '122', '2024-11-07');
INSERT INTO `message` VALUES (40, '李硕666', '12345679', '2024-10-12');
...
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '回复表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of replay
-- ----------------------------
INSERT INTO `replay` VALUES (37, 22, '真的难', '2024-04-03');
INSERT INTO `replay` VALUES (37, 23, '同感', '2024-04-03');
INSERT INTO `replay` VALUES (39, 24, '还行', '2024-10-12');
...
) ENGINE = InnoDB AUTO_INCREMENT = 144 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '成绩管理表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of score
-- ----------------------------
INSERT INTO `score` VALUES (4, 20190001, 20224001, '计算机网络', NULL, 70, NULL, '2024-04-03');
INSERT INTO `score` VALUES (14, 20190002, 20154084, '数据库理论', NULL, 78, NULL, '2024-04-03');
INSERT INTO `score` VALUES (15, 20190002, 20154084, '数据库理论', NULL, 80, NULL, '2024-04-03');
INSERT INTO `score` VALUES (16, 20190002, 20154084, '数据库理论', NULL, 83, NULL, '2024-04-03');
INSERT INTO `score` VALUES (17, 20190001, 20154001, '计算机网络', NULL, 74, NULL, '2024-04-03');
INSERT INTO `score` VALUES (18, 20190001, 20154001, '计算机网络', NULL, 70, NULL, '2024-04-03');
INSERT INTO `score` VALUES (19, 20190001, 20155003, '计算机网络', NULL, 86, NULL, '2024-04-03');
INSERT INTO `score` VALUES (20, 20190001, 20155007, '计算机网络', NULL, 90, NULL, '2024-04-03');
INSERT INTO `score` VALUES (21, 20190001, 20155007, '计算机网络', NULL, 92, NULL, '2024-04-03');
INSERT INTO `score` VALUES (22, 20190001, 20155008, '计算机网络', NULL, 80, NULL, '2024-04-03');
INSERT INTO `score` VALUES (23, 20190001, 20155003, '计算机网络', NULL, 90, NULL, '2024-04-03');
INSERT INTO `score` VALUES (24, 20190001, 20155008, '计算机网络', NULL, 88, NULL, '2024-04-03');
INSERT INTO `score` VALUES (27, 20190001, 20154084, '计算机网络', NULL, 80, NULL, '2024-04-03');
INSERT INTO `score` VALUES (30, 20190001, 20154084, '计算机网络', NULL, 0, NULL, '2024-04-03');
INSERT INTO `score` VALUES (31, 20190001, 20154084, '计算机网络', NULL, 0, NULL, '2024-04-03');
INSERT INTO `score` VALUES (32, 20190001, 20154084, '计算机网络', NULL, 0, NULL, '2024-04-03');
INSERT INTO `score` VALUES (33, 20190001, 20224084, '计算机网络', NULL, 4, NULL, '2024-04-03');
INSERT INTO `score` VALUES (34, 20190001, 20224084, '计算机网络', NULL, 4, NULL, '2024-04-03');
INSERT INTO `score` VALUES (35, 20190001, 20224084, '计算机网络', NULL, 2, NULL, '2024-04-03');
INSERT INTO `score` VALUES (36, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-08');
INSERT INTO `score` VALUES (37, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-08');
INSERT INTO `score` VALUES (38, 20190001, 20224084, '计算机网络', NULL, 8, NULL, '2024-03-09');
INSERT INTO `score` VALUES (39, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (40, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (41, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (42, 20190002, 20224084, '数据库理论', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (43, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (44, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (45, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (46, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (47, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (48, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (49, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (50, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (51, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (52, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (53, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (54, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (55, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (56, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (57, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (58, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (59, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (60, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (61, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (62, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (63, 20190014, 20224084, 'Java程序设计', NULL, 2, NULL, '2024-03-09');
INSERT INTO `score` VALUES (64, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (65, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (66, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (67, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (68, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (69, 20190015, 20224084, 'C#', NULL, 2, NULL, '2024-03-09');
INSERT INTO `score` VALUES (70, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (71, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (72, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (73, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (74, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (75, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (76, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (77, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (78, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (79, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (80, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (81, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (82, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (83, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (84, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (85, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (86, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (87, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (88, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (89, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (90, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (91, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (92, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (93, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (94, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (95, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (96, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-09');
INSERT INTO `score` VALUES (97, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (98, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (99, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (100, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (101, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (102, 20190015, 20224084, 'C#', NULL, 2, NULL, '2024-03-13');
INSERT INTO `score` VALUES (103, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (104, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (105, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (106, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (107, 20190015, 20224084, 'C#', NULL, 2, NULL, '2024-03-13');
INSERT INTO `score` VALUES (108, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (109, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (110, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (111, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (112, 20190015, 20224084, 'C#', NULL, 2, NULL, '2024-03-13');
INSERT INTO `score` VALUES (113, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (114, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (115, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (116, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (117, 20190015, 20224084, 'C#', NULL, 2, NULL, '2024-03-13');
INSERT INTO `score` VALUES (118, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (119, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (120, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (121, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (122, 20190015, 20224084, 'C#', NULL, 2, NULL, '2024-03-13');
INSERT INTO `score` VALUES (123, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (124, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (125, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (126, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (127, 20190015, 20224084, 'C#', NULL, 2, NULL, '2024-03-13');
INSERT INTO `score` VALUES (128, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (129, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (130, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (131, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (132, 20190015, 20224084, 'C#', NULL, 2, NULL, '2024-03-13');
INSERT INTO `score` VALUES (133, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (134, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (135, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (136, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (137, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-03-13');
INSERT INTO `score` VALUES (138, 20190001, 20224084, '计算机网络', NULL, 2, NULL, '2024-04-02');
INSERT INTO `score` VALUES (139, 20190001, 20224084, '计算机网络', NULL, 4, NULL, '2024-04-02');
INSERT INTO `score` VALUES (140, 20190001, 20224084, '计算机网络', NULL, 4, NULL, '2024-04-02');
INSERT INTO `score` VALUES (141, 20190001, 20224084, '计算机网络', NULL, 0, NULL, '2024-04-05');
INSERT INTO `score` VALUES (142, 20190001, 20224084, '计算机网络', NULL, 2, NULL, '2024-04-05');
INSERT INTO `score` VALUES (143, 20190001, 20224001, '计算机网络', NULL, 24, NULL, '2024-11-08');
...
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES (20213615, 'user', '2021', '软件工程', '软工互211', '软件学院', '15139471712', '123@qq.com', '123456', '445444444444444444', '男', '2');
INSERT INTO `student` VALUES (20224001, 'user1', '2021', '计算机科学与技术', '软工互212', '软件学院', '13585411132', 'gblw@163.com', '123456', '500234597988722353', '男', '2');
INSERT INTO `student` VALUES (20224084, 'user2', '2021', '计算机科学与技术', '软工互212', '软件学院', '13658555557', '13658555557@sina.cn', '123456', '500574111114022353', '男', '2');
INSERT INTO `student` VALUES (20225003, 'user3', '2021', '信息工程', '软工互211', '软件学院', '15512345425', '15512345425@163.com', '123456', '500237781114022353', '男', '2');
INSERT INTO `student` VALUES (20225007, 'user4', '2021', '网络工程', '软工互211', '软件学院', '18777778457', '18777778457@163.com', '123456', '500234565548022353', '女', '2');
INSERT INTO `student` VALUES (20225008, 'user5', '2021', '信息工程', '软工互212', '软件学院', '15111619564', '15111619564@163.com', '123456', '500234111114022353', '男', '2');
INSERT INTO `student` VALUES (20225009, 'user6', '大一', '软件工程', '软工互221', '计算机学院', '13355555555', '123@qq.com', '123456', '445444444444444444', '男', '2');
...
-- Records of teacher
-- ----------------------------
INSERT INTO `teacher` VALUES (20081001, '李老师', '软件学院', '男', '13500008442', '13500008442@163.com', '123456', '465111111111111111', '讲师', '1');
INSERT INTO `teacher` VALUES (20081002, '张老师', '软件学院', '男', '1231221312', '1231221312@163.com', '123456', '455111111111111233', '讲师', '1');
INSERT INTO `teacher` VALUES (20081003, '王老师', '计算机学院', '男', '13333333333', NULL, '123456', '441111111111111111', '教师', '1');
INSERT INTO `teacher` VALUES (20081005, '马老师', '计算机学院', '女', '15877777777', NULL, '123456', '445111111111111111', '普通人', '1');
